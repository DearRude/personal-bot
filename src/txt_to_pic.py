...
def text_to_pic(text, writer, font=def_font,
                font_size=30, pic=base_pic, align="center"):
    ...
    with Image.open(base_pic) as picture:
        ...
        draw.text(xy=gen_xy(text, align)[0],
                  text=text,
                  font=text_font,
                  align=align,
                  fill="black",
